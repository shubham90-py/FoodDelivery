...
import com.example.fooddelivery.ReusableCodeForAll;
...
public class ChefRegistration extends AppCompatActivity {
    String[] Rajasthan={"Ajmer","Alwar","Bhilwara","Bikaner","Jhalawar","Jaipur","Jodhpur","Kota","Udaipur"};
    String[] MadhyaPradesh={"Bhopal","Gwalior","Indore","Jabalpur","Mandsour","Nimach","Ratlam","Ujjain"};
    String[] Gujarat={"Ahemdabad","Bharuch","","Gandhinagar","Rajkot","Surat","Vadodara"};
    String[] Maharashtra={"Aurangabad","Jalgaon","Kolhapur","Mumbai","Nagpur","Nashik","Pune"};
